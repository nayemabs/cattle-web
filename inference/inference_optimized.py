...
def calculate_cattle_weight(cattle, sticker, predicted_cattle_weight, status):
    # Define the upper bounds and weight factors
    bounds_factors = [
        (50, -0.68),
        (55, -0.57),
        (60, -0.48),
    ...
    # Loop over the bounds_factors list
    for bound, factor in bounds_factors:
        if cattle/sticker < bound:
    ...
    # If none of the bounds_factors match, return the default result
    res = {"weight": predicted_cattle_weight, "ratio": cattle/sticker, "remarks": status}
    #os.remove(side_img)
    #os.remove(rear_img)
def optimize_null_weight(cattle, sticker, predicted_cattle_weight, status):
    ...
    for threshold, multiplier in weight_multipliers:
        if cattle / sticker < threshold:
            predicted_cattle_weight += (cattle / sticker) * multiplier
            res = (predicted_cattle_weight, cattle / sticker, status)
            return res
    return
...
def predict(side_fname,rear_fname):
    ...
    # KPT rear and side
        ...
        res = {"weight":predicted_cattle_weight,"ratio": cattle/sticker ,"remarks":status}
        calculate_weight(cattle, sticker, predicted_cattle_weight, status)
        ...
        try:
            ...
            optimize_null_weight(cattle, sticker, predicted_cattle_weight, status)
        except:
            predicted_cattle_weight= 0
